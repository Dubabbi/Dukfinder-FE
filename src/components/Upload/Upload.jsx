  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      .then(response => {
        ...
        axios.get('https://port-0-dukfinder-57lz2alpp5sfxw.sel4.cloudtype.app/find_posts/catecory/location/', {
          headers: {
            Authorization: `Token ${token}`
          }
        })
      ...
      .then(response => {
        ...
        axios.get('https://port-0-dukfinder-57lz2alpp5sfxw.sel4.cloudtype.app/find_posts/catecory/category/', {
          headers: {
            Authorization: `Token ${token}`
          }
        })
