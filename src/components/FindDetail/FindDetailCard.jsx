    ...
    return (
        <D.CardStyle style={{ width: '65rem' }}>
            <D.YellowCardBody>
                ...
                <D.SubtitleContainer className="mb-3 text-muted"><span>습득날짜:</span> {post.p_date}</D.SubtitleContainer>
                <D.SubtitleContainer className="mb-3 text-muted"><span>습득장소:</span> {post.p_findPlace}</D.SubtitleContainer>
                <D.SubtitleContainer className="mb-3 text-muted"><span>보관장소:</span> {post.p_keepPlace}</D.SubtitleContainer>
